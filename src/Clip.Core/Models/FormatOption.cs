...
public sealed class FormatOption
{
    ...
    public string DisplayName
    {
        get
        {
            ...
            var extension = string.IsNullOrWhiteSpace(Extension) ? "media" : Extension.ToUpperInvariant();
            return string.IsNullOrWhiteSpace(resolution) ? extension : $"{resolution} {extension}";
        }
    }
}
